...
class MessageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Message
        fields = [
            'mid', 'conversation', 'sender', 'sender_name', 
            'sender_email', 'message', 'image', 'message_type',
            'timestamp', 'is_read'
        ]
        read_only_fields = [
            'mid', 'conversation', 'timestamp', 
...
class LastMessageSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Message
        fields = [
            'message', 'sender', 'sender_id', 'sender_name', 
            'timestamp', 'is_read', 'image', 'message_type'
        ]
...
class ConversationSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Conversation
        fields = [
            'cid', 'user', 'user_details', 'slug', 
            'created_at', 'last_message', 'unread_count', 'is_online'
        ]
        read_only_fields = [
            'cid', 'created_at', 'slug', 'last_message', 
