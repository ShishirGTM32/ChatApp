...
import type { Blocker, BlockerFunction, Location, ParamParseKey, Params, Path, PathMatch, PathPattern, RelativeRoutingType, Router as RemixRouter, RevalidationState, To, UIMatch } from "../../../../frontend/node_modules/@remix-run/router/dist";
import { Action as NavigationType } from "../../../../frontend/node_modules/@remix-run/router/dist";
import type { NavigateOptions, RouteContextObject, RouteMatch, RouteObject } from "../../../../frontend/node_modules/react-router/dist/lib/contexte full href for the given "to" value. This is useful for building
 ...
 */
export declare function useNavigation(): import("@remix-run/router").../../../../frontend/node_modules/@remix-run/router/dist* Returns a revalidate function for manually triggering revalidation, as well
