import type { History, Location, Path, To } from "../../../../frontend/node_modules/@remix-run/router/dist/history HistoryAction } from "./history";
import ty../../../../frontend/node_modules/@remix-run/router/dist/historygnosticDataRouteObject, AgnosticRouteObject, DataStrategyFunction, DeferredData, DetectErrorBoundaryFunction, FormEncType, HTMLFormMethod, MapRoutePropertiesFunction, RouteData, Submission, UIMatch, AgnosticPatchRoutesOnNavigationFunction, DataWithResponseInit } from "./utils";
/**
 * A Router instance manages../../../../frontend/node_modules/@remix-run/router/dist/utilsding/mutations
 */
